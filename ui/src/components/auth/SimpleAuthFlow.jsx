  ...
  return (
    <div style={wrap} data-auth-overlay>
      <div style={box}>
        ...
        <div style={row}>
  <Button size="lg" className="px-5 py-3" onClick={() => alert("Login clicked")}>Login — Existing User</Button>
  <Button size="lg" className="px-5 py-3" onClick={signup}>Signup — New User</Button>
</div>
      </div>
    </div>
  );
